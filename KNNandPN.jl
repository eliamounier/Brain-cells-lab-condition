...
self_tuning_mach_pn = machine(self_tuning_model_pn, train_input, Y)
...
self_tuning_machine_KNN = machine(self_tuning_model_KNN, train_input, Y)
...
# didn't finish running after 9 hours -> didn't try further
